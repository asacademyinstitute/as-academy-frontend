                ...
                <div className="prose max-w-none space-y-8">
                    ...
                    <section className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                            ...
                            <li>50% refund available within 1 days if less than 20% of course content has been accessed</li>
                            <li>No refunds after the 2-day period or if more than 20% content is accessed</li>
